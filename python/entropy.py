...
if __name__=='__main__':
    ...
    p1 = mp.Process(target = parFilter, args = (taskList[0],queueList[0],1,12000))
    p2 = mp.Process(target = parFilter, args = (taskList[1],queueList[1],2,12000))
    p3 = mp.Process(target = parFilter, args = (taskList[2],queueList[2],3,12000))
    p4 = mp.Process(target = parFilter, args = (taskList[3],queueList[3],4,12000))
    p1.start()
    p2.start()
    p3.start()
    p4.start()
